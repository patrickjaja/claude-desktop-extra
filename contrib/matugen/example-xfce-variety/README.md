...
|------|--------------|---------|
| `config.toml` | `~/.config/matugen/config.toml` | [matugen](https://github.com/InioX/matugen) templates: GTK3/GTK4 colors, Claude overlays (accents / backgrounds / full palette), full theme |
